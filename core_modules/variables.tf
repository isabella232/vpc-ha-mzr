...
* Type: bool
* Desc: Determines whether to enable IG or not. Enter true or false.
**/
variable "enable_autoscaling" {
  description = "Determines whether to enable IG or not. Enter true or false."
  type        = bool
}
...
/**
* Name: zones
* Desc: The zone where the subnets will be created
* Type: string
**/
variable "zones" {
  description = "The zone where the subnets will be created"
  type        = list(any)
}
/**
* Name: regions
